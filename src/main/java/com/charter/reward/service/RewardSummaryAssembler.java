...
public class RewardSummaryAssembler {
	...
	public RewardSummaryResponse assemble(Customer customer, LocalDate startDate, LocalDate endDate,
		...
		return new RewardSummaryResponse(customer.getId(), customer.getFullName(), customer.getEmail(), startDate,
				endDate, transactions.size(), totalPoints, monthlyRewards);
	}
