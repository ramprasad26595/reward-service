...
import com.charter.reward.validation.RewardCalculator;
...
public class RewardSummaryMapper {
	...
	/**
	 * Builds a per-transaction reward breakdown.
	 *
	 * @param transactions matching transactions
	 * @return transaction-level details
	 */
	public List<TransactionDetailResponse> buildTransactionDetails(List<PurchaseTransaction> transactions) {
	...
	/**
	 * Builds summaries for each month in the requested range.
	 *
	 * @param transactions matching transactions
	 * @param startDate requested start date
	 * @param endDate requested end date
	 ...
	 */
	public List<MonthlyRewardResponse> buildMonthlyRewards(List<PurchaseTransaction> transactions, LocalDate startDate,
			LocalDate endDate) {
