...
class RewardSummaryMapperTest {
	...
	private final RewardSummaryMapper assembler = new RewardSummaryMapper(new RewardCalculator());
	...
	void assemblesCustomerAndTransactionDetails() {
		...
		RewardSummaryResponse response = assembler.assemble(customer, LocalDate.parse("2026-04-01"),
